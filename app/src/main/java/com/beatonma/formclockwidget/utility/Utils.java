...
public class Utils {
	...
	private static int PORTER_DUFF_MODE = 0;
...
//						android.R.attr.state_activated
	...
	// Convenience method for testing PorterDuff effects
	public static PorterDuff.Mode getPorterDuffMode(boolean cycle) {
		PorterDuff.Mode[] modes = PorterDuff.Mode.values();
		PorterDuff.Mode mode = modes[(cycle ? PORTER_DUFF_MODE++ : PORTER_DUFF_MODE) % modes.length];
		Log.d(TAG, "Selected mode name: " + mode.name());
		return mode;
	}
}
