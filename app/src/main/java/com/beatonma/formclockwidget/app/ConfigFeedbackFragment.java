 ...
 */
public class ConfigFeedbackFragment extends ConfigBaseFragment {
    public static ConfigFeedbackFragment newInstance() {
        return new ConfigFeedbackFragment();
    }

    @Override
    int getLayout() {
        return R.layout.fragment_config_feedback;
    }
